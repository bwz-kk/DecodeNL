...
public class GoalSide15Auto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        Pose startPose = new Pose(31, 134, Math.toRadians(-90));

        shootingPose = new Pose(58, 88, Math.toRadians(-160));
        shootingPose2 = new Pose(61, 100, Math.toRadians(-150));
        ...
        Pose endSecondRow = new Pose(19, 60, Math.toRadians(180));

        Pose startThirdRow = new Pose(43, 40, Math.toRadians(180));
        Pose endThirdRow = new Pose(19, 40, Math.toRadians(180));

        Pose gateIntake = new Pose(9, 61, Math.toRadians(160));
        Pose gateControl = new Pose(15, 57, 0);
        Pose gateIntake2 = new Pose(15, 55, Math.toRadians(90));

        Pose openGate = new Pose(12, 73, Math.toRadians(-120));

        Pose Leave = new Pose(38, 86, Math.toRadians(-170));
